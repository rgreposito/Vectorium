...
export default function Team() {
  return (
    <section id="team" className="section text-gray-100 relative overflow-hidden">
      ...
      <div className="absolute bottom-20 right-10 w-96 h-96 bg-goldLight/10 rounded-full blur-3xl animate-pulse" style={{animationDelay: '1s'}}></div>
      ...
      <div className="container text-center relative z-10">
        ...
        <div className="max-w-5xl mx-auto mb-20">
          <div className="inline-flex items-center gap-3 px-6 py-3 rounded-full bg-gradient-to-r from-gold/10 via-gold/5 to-goldLight/10 border border-gold/30 mb-8 backdrop-blur-sm hover:border-gold/50 transition-all duration-300 group">
            ...
            <span className="text-sm text-gold font-semibold uppercase tracking-widest">Our Elite Team</span>
            <svg className="w-4 h-4 text-gold group-hover:translate-x-1 transition-transform duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <p className="text-xl md:text-2xl text-gray-300 leading-relaxed max-w-3xl mx-auto font-light">
            The brilliant minds architecting the future of decentralized intelligence at
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-gold to-goldLight font-bold"> VECT • AI</span>
          </p>
            ...
            <div className="relative bg-gradient-to-br from-midnight/90 via-ink/90 to-midnight/90 backdrop-blur-xl border-2 border-gold/30 rounded-3xl p-12 hover:border-gold/60 transition-all duration-500 overflow-hidden">
              ...
              <div className="relative z-10">
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gold/10 border border-gold/30 mb-6">
                  ...
                  <span className="text-sm text-gold font-bold uppercase tracking-wider">Join the Revolution</span>
                </div>
                ...
                <p className="text-lg text-gray-300 leading-relaxed mb-8 max-w-2xl mx-auto">
                  We're assembling the world's most innovative team to revolutionize AI through blockchain technology. 
                  If you're passionate about pushing boundaries, we want to hear from you.
                </p>
                
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                  <a 
                    href="mailto:careers@vectorium.co" 
